...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/ls/Documents/code/planit/planit/sqlite3.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 't%+h0jt&amp;r5ujffd(u%9ss2!mpy2_+j1xrxicjv5renzmtjxsmn'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/Users/ls/Documents/code/planit/templates',
)
