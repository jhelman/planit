...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Plan.startYear'
        db.delete_column('planner_plan', 'startYear_id')

        # Deleting field 'Plan.numYears'
        db.delete_column('planner_plan', 'numYears')

        # Adding field 'Plan.start_year'
        db.add_column('planner_plan', 'start_year', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['planner.Year']), keep_default=False)

        # Adding field 'Plan.num_years'
        db.add_column('planner_plan', 'num_years', self.gf('django.db.models.fields.IntegerField')(default=4), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Plan.startYear'
        db.add_column('planner_plan', 'startYear', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['planner.Year']), keep_default=False)

        # Adding field 'Plan.numYears'
        db.add_column('planner_plan', 'numYears', self.gf('django.db.models.fields.IntegerField')(default=4), keep_default=False)

        # Deleting field 'Plan.start_year'
        db.delete_column('planner_plan', 'start_year_id')

        # Deleting field 'Plan.num_years'
        db.delete_column('planner_plan', 'num_years')
    ...
    models = {
        ...
        'planner.year': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'startNum': ('django.db.models.fields.IntegerField', [], {})
        }
    }
