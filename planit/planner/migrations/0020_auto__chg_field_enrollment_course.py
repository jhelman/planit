...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Enrollment.course'
        db.alter_column('planner_enrollment', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.CourseOffering']))
    
    
    def backwards(self, orm):
        
        # Changing field 'Enrollment.course'
        db.alter_column('planner_enrollment', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.Course']))
