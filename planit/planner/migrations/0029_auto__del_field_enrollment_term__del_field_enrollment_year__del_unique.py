...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Enrollment', fields ['course', 'plan']
        db.create_unique('planner_enrollment', ['course_id', 'plan_id'])
    ...
    def backwards(self, orm):
        ...
        db.add_column('planner_enrollment', 'year', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
        ...
        # Removing unique constraint on 'Enrollment', fields ['course', 'plan']
        db.delete_unique('planner_enrollment', ['course_id', 'plan_id'])
