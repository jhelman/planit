...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Year.num'
        db.delete_column('planner_year', 'num')

        # Adding field 'Year.startNum'
        db.add_column('planner_year', 'startNum', self.gf('django.db.models.fields.IntegerField')(default=2012), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Year.num'
        db.add_column('planner_year', 'num', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Year.startNum'
        db.delete_column('planner_year', 'startNum')
