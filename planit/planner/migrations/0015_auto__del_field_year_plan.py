...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Year.plan'
        db.delete_column('planner_year', 'plan_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Year.plan'
        db.add_column('planner_year', 'plan', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['planner.Plan']), keep_default=False)
