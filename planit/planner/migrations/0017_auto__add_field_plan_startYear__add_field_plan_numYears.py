...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('planner_plan', 'startYear', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['planner.Year']), keep_default=False)
    ...
    models = {
        ...
        'planner.plan': {
            ...
            'numYears': ('django.db.models.fields.IntegerField', [], {'default': '4'}),
            'startYear': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['planner.Year']"}),
