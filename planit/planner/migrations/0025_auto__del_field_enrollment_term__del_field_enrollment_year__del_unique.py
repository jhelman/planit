...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('planner_enrollment', 'year_id')

        # Removing unique constraint on 'Enrollment', fields ['course', 'term', 'plan', 'year']
        db.delete_unique('planner_enrollment', ['course_id', 'term_id', 'plan_id', 'year_id'])
    ...
    def backwards(self, orm):
        ...
        db.add_column('planner_enrollment', 'year', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['planner.Year']), keep_default=False)

        # Adding unique constraint on 'Enrollment', fields ['course', 'term', 'plan', 'year']
        db.create_unique('planner_enrollment', ['course_id', 'term_id', 'plan_id', 'year_id'])
