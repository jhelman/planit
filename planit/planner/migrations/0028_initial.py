...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Enrollment', fields ['plan', 'term', 'year', 'course']
        db.create_unique('planner_enrollment', ['plan_id', 'term_id', 'year', 'course_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Enrollment', fields ['plan', 'term', 'year', 'course']
        db.delete_unique('planner_enrollment', ['plan_id', 'term_id', 'year', 'course_id'])
